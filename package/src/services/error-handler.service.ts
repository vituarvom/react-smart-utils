...
class ErrorHandler {
   ...
   * @param {unknown} receivedValue - The actual value that caused the error.
   */
  public throwError(
    errorType: ErrorType,
    expectedType: string,
    ...
    const errorClasses: {
      [key in ErrorType]: new (message: string) => Error;
    } = {
      TypeError,
      RangeError,
      ReferenceError,
